		...
		<?php } else {?>
			...
			<tbody>
				...
				<tr>
					...
					<td>  </td> 
					<td name=quantity><form action="index.php" method="GET"><input type="hidden" name="page" value="modif_cart"><input type="hidden" name="id_produit" value="<?php echo $product_id?>"><input name="quantity" class="quantity" type="number" min="0" value="<?php echo $donneeCart['Q']?>"></form><br><br>
